...
class AllSubCategories extends StatefulWidget {
  ...
  AllSubCategories(this.mainCategory);
                              ...
                              child: InkWell(
                                onTap: ()async{
                                  ...
                                  FirebaseFirestore.instance.collection('categories')
                                      .where("mainCategoryId", isEqualTo: widget.mainCategory.id).get().then((QuerySnapshot querySnapshot) {
                        ...
                        Expanded(
                          child: StreamBuilder<QuerySnapshot>(
                            stream: FirebaseFirestore.instance.collection('categories')
                                .where("mainCategoryId", isEqualTo: widget.mainCategory.id)
